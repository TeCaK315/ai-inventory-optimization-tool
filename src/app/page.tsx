      ...
      <header className="border-b border-gray-800 bg-gray-900/50 backdrop-blur-xl sticky top-0 z-50">
        <div className="max-w-5xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-bold text-lg">AI Inventory Optimization Tool Analyzer</h1>
              <p className="text-xs text-gray-400">Помогает малым и средним предприятиям точно управлять запасами, снижая затраты и улучшая обслуживание клиентов.</p>
            </div>
          </div>
          <button
